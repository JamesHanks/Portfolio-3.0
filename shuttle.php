...
<section class="case-study-intro" id="intro">
	...
	<div class="case-study-hero">
		...
		<div class="case-study-intro-image shuttle"></div>
	</div>
	...
	<div class="case-study-container">
		...
		<div class="case-study-text-wrap">
			<div class="case-study-brief">
				...
				<p>Pitch a new product or service for a randomly selected brand promoting their core values which in turn should increase customer outreach.</p>
			</div>
			...
			<div class="case-study-details">
				...
				<div class="case-study-client">
					...
					<p><a href="http://www.integrity.co.uk/" target="blank">Integrity</a></p>
				</div>
				<div class="case-study-category">
					<span class="heading-small">Category</span>
					<p>Digital Product Design, UI/UX</p>
				</div>
			</div>	
		</div>
		...
		<div class="case-study-text-wrap">
			<div class="column-1">
				<p>The company received was Sainsbury’s, whose brand values include ‘having respect for our environment' and ‘making a positive difference to our community'. I decided upon creating a service that enforced these values directly by reducing use of petrol, bringing the local community together and helping those in need.</p>

				<p>Sainsbury’s Shuttle is a proximity-based mobile application where users sign up as ‘transporters’ and/or ‘passengers’.</p> 

				<p>Transporters receive bonus Nectar points and rewards for giving Passengers lifts to local Sainsbury’s stores. A Passenger could be anyone who struggles with accessing a supermarket (e.g. due to a disability, old-age or lack of transport).</p>
			</div>

			<div class="column-2">
				<p>The app displays profiles of people who are online and require each other's service as pointers on a map. The user will be able to select a pointer, view a profile in full and request their service. If accepted, they will then be able to message the other user regarding the lift that will take place.</p>
		...
		<div class="case-study-image-wrap">
			...
			<div class="image-container">
				<img src="assets/images/shuttle_2.jpg" alt="Project Image">
			</div>

			<div class="image-container">
				<img src="assets/images/shuttle_3.jpg" alt="Project Image">
			</div>

			<div class="image-container">
				<img src="assets/images/shuttle_4.jpg" alt="Project Image">
			</div>

			<div class="image-container">
				<img src="assets/images/shuttle_5.jpg" alt="Project Image">
			</div>

			<div class="image-container">
				<img src="assets/images/shuttle_6.jpg" alt="Project Image">
			</div>
...
<div class="case-study-arrows-container">
	...
	<a href="apto.php" class="animsition-link">
	...
	<a href="sketchbook.php" class="animsition-link">
